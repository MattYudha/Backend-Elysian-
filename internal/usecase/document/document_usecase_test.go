...
type MockDocumentRepository struct {
	...
	UpdateTitleFunc  func(ctx context.Context, id uuid.UUID, title string) error
...
func (m *MockDocumentRepository) UpdateTitle(ctx context.Context, id uuid.UUID, title string) error {
